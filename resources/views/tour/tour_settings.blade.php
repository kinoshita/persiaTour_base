    ...
    <div class="w-full flex justify-center">
        <form class="shadow-md rounded-b-md bg-white w-full max-w-2xl p-2 " method="get" action="{{ route('confirm.tour') }}">
            ...
            <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                ...
                <input type="text" class="block w-full sm:w-3/5 py-2 px-3 text-gray-700 border border-gray-200 rounded focus:outline-none focus:bg-white" id="tour_name" name="tour_name" placeholder="NTC Northen Iran" value=""/>
            </div>
            <div>
                <span class="flex justify-center text-red-600">

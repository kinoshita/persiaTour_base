    ...
    <body class="bg-gray-50">
        <section class="text-gray-600 w-full flex flex-col items-center px-2">
            ...
            <div class="w-full flex justify-center">
                <form class="shadow-md rounded-b-md bg-white w-full max-w-2xl p-10" method="post" action="{{ route('hotel.complete') }}">
                    @csrf
                    <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                        ...
                        <input type="hidden" name="city_name" value="{{ $all['city_name'] }}" />
                    ...
                    <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                        ...
                        <input type="hidden" name="hotel_name" value="{{ $all['hotel_name'] }}" />
                    ...
                    <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                        ...
                        <input type="hidden" name="address" value="{{ $all['address'] }}" />
                    ...
                    <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                        ...
                        <input type="hidden" name="tel" value="{{ $all['tel'] }}" />
                    ...
                    <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                        ...
                        <input type="hidden" name="fax" value="{{ $all['fax'] }}" />

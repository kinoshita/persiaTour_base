    ...
    <div class="">
        <form class="shadow-md rounded-b-md bg-white w-full max-w-2xl p-10" method="post" action="{{ route('hotel.settings') }}">
            ...
            <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                ...
                <div class="block w-full sm:w-3/5 bg-gray-200 py-2 px-3 text-gray-700 border border-gray-200 rounded focus:outline-none focus:bg-white" id="city_name">
                {{$hotel->city}}
                </div>
            </div>
            <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
                ...
                <div class="block w-full sm:w-3/5 py-2 px-3 text-gray-700 border border-gray-200 rounded focus:outline-none focus:bg-white"  id="hotel_name">
                {{$hotel->hotel_name}}
                </div>
            </div>
            <div class="flex sm:items-center mb-6 flex-col sm:flex-row">
